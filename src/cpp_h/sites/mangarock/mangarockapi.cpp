...
void MangarockApi::doWork()
{
    ...
    logging("Starting download manga with OID " + oid + '.');
    ...
    logging("Info page thumbnail and cover downloaded.");
    ...
    for (int i = 0; i < arrJ.size(); i++)
    {
        ...
        for (int j = 0; j < pageLinks.size(); j++)
        {
            ...
            logging("Page #" + std::to_string(j) + " in chapter " + std::to_string(i) + " downloaded.");
        }
    }
